...
class SFDTargetSpaceSearcher:
    ...
    def search_optimal_areas(self, sdf_array, center_x, height, target_density):
        left_result = self._search_left_side(sdf_array, center_x, height, target_density)
        right_result = self._search_right_side(sdf_array, center_x, height, target_density)
